# Cocoa bean production - Data package

This data package contains the data that powers the chart ["Cocoa bean production"](https://ourworldindata.org/grapher/cocoa-bean-production?v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on February 01, 2025.
...
#### Full citation
Food and Agriculture Organization of the United Nations (2023) – with major processing by Our World in Data. “Cocoa bean production – FAO” [dataset]. Food and Agriculture Organization of the United Nations, “Production: Crops and livestock products” [original data].
